  ...
  const cardContent = (
    ...
    >
      ...
      >
        ...
        <Card.Body p={2} gap={1}>
          <Card.Title truncate lineClamp={2} fontSize={'md'} fontWeight="bold" pb="6px">
            {title}
          </Card.Title>
          <Box>
            <ReleaseBadge release={releaseType} fontSize="xs" fontWeight="medium" />
